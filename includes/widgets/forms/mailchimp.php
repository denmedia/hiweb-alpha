<?php
	...
	/**
	 * Class mailchimp
	 * @package hiweb_theme\widgets\forms
	 */
	class mailchimp{
		...
		public function get_lists(){
			if( !$this->is_api_key_exists() ) return [];
		...
		public function is_api_key_exists(){
			return trim( get_field( 'api-key', forms::$options_name_mailchimp ) ) != '';
		}
		...
		public function is_connected(){
			if( !$this->is_api_key_exists() ) return false;
			$this->get_lists();
