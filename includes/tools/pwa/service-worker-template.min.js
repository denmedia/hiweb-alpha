...
$jscomp.polyfill("Promise",function(a){function b(){this.batch_=null}function c(a){return a instanceof d?a:new d(function(f,b){f(a)})}if(a&&!$jscomp.FORCE_POLYFILL_PROMISE)return a;b.prototype.asyncExecute=function(a){null==this.batch_&&(this.batch_=[],this.asyncExecuteBatch_());this.batch_.push(a);return this};b.prototype.asyncExecuteBatch_=function(){var a=this;this.asyncExecuteFunction(function(){a.executeBatch_()})};var e=$jscomp.global.setTimeout;b.prototype.asyncExecuteFunction=function(a){e(a,
...
var CACHE_VERSION=1,CURRENT_CACHES={offline:"offline-v"+CACHE_VERSION},OFFLINE_URL="offline.html";function createCacheBustedRequest(a){var b=new Request(a,{cache:"reload"});if("cache"in b)return b;a=new URL(a,self.location.href);a.search+=(a.search?"&":"")+"cachebust="+Date.now();return new Request(a)}self.addEventListener("install",function(a){a.waitUntil()});
self.addEventListener("activate",function(a){var b=Object.keys(CURRENT_CACHES).map(function(a){return CURRENT_CACHES[a]});a.waitUntil(caches.keys().then(function(a){return Promise.all(a.map(function(a){if(-1===b.indexOf(a))return console.log("Deleting out of date cache:",a),caches.delete(a)}))}))});
self.addEventListener("fetch",function(a){if("navigate"===a.request.mode||"GET"===a.request.method&&a.request.headers.get("accept").includes("text/html"))console.log("Handling fetch event for",a.request.url),a.respondWith(fetch(a.request).catch(function(a){console.log("Fetch failed; returning offline page instead.",a);return caches.match(OFFLINE_URL)}))});
