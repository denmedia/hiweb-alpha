...
try {
    spl_autoload_register(function($class) {
        ...
        $search_paths = [
            HIWEB_THEME_COMPONENTS_DIR . '/' . $class_path,
            HIWEB_THEME_COMPONENTS_DIR . '/' . $class_basename . '/' . $class_path,
    ...
    \hiweb\components\Console\ConsoleFactory::add('Функция [spl_autoload_register] не работает.', 'warn', __FILE__, [], true);
}