...
add_action('init', function() {
    ...
    add_field_checkbox('canonical-paged-first-link')->default_value(true)->label_checkbox('Выводить каноническую ссылку на странице пагинации, ссылка на первую страницу')->description('Пример кода: <code>' . htmlentities('<link rel=”canonical” href=”http://...” />') . '</code>')->location(true);
    add_field_checkbox('canonical-paged-prev-next-links')->default_value(true)->label_checkbox('Выводить канонические ссылки на странице пагинации, ссылки на предыдущую и следующую страницы')->description('Пример кода: <code>' . htmlentities('<link rel=”next” href=”http://...” />') . '</code>')->location(true);
    add_field_checkbox('canonical-all-pages')->default_value(true)->label_checkbox('Выводить каноническую ссылку на всех страницах не пагинации, ссылка на текущую страницу')->description('Пример кода: <code>' . htmlentities('<link rel=”canonical” href=”http://...” />') . '</code>')->location(true);
