...
class bootstrap {
    ...
    private static $cols_to_class_double = [
        ...
        '2.2' => 'col-6',
        '2.3' => 'col-6 col-lg-4',
        '2.4' => 'col-6 col-md-4 col-lg-3',
        '2.6' => 'col-6 col-sm-4 col-md-3 col-lg-2',
        '2.12' => 'col-6 col-sm-4 col-md-3 col-lg-1',
        '3.3' => 'col-4',
    ...
    static $piece_to_class_simple = [
        '1/1' => 'col-12',
        '1/2' => 'col-12 col-md-6',
        '1/3' => 'col-12 col-md-4',
        '1/4' => 'col-12 col-md-3',
        '1/5' => 'col-6 col-md-5th',
        '1/6' => 'col-6 col-md-2',
        '1/12' => 'col-6 col-md-1',
        '2/3' => 'col-12 col-md-8',
        '3/4' => 'col-12 col-md-9',
        '5/6' => 'col-12 col-md-10',
        '5/12' => 'col-12 col-md-5',
        '7/12' => 'col-12 col-md-7',
        '11/12' => 'col-12 col-md-11',
    ];


    /**
     * Return bootstrap col class from piece string like '1/2'.
     * See more pieces in 'dump_var(array_keys(theme/bootstrap::$piece_to_class_simple));'
     * @param string $piece
     * @return string
     */
    static function piece_to_class_simple($piece = '1/2'): string {
        $piece = preg_replace('~([\d]+)([^\d])([\d]+)~', '$1/$3', $piece);
        if ( !array_key_exists($piece, self::$piece_to_class_simple)) $piece = '1/2';
        return self::$piece_to_class_simple[$piece];
    }
