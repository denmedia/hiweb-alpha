<?php
	...
	add_field_select( 'message-rest-exported' )->options( [ '1' => 'Экспортировать', '0' => 'Не экспортировать' ] )->label( 'Не выводить в REST для экспорта в ЦРМ' )->LOCATION()->POST_TYPES( forms::$post_type_messages_name )->META_BOX()->title( 'REST экспорт' )->context()->side()->priority()->high();
