<?php
	...
	class button extends input{
			...
			static function add_repeat_field( Field_Repeat_Options $parent_repeat_field ){
				$parent_repeat_field->add_col_flex_field( self::$input_title, add_field_text( 'label' )->placeholder( 'Отправить' )->default_value( 'Отправить' ) )->label( 'Кнопка с текстом' )->compact( 1 );
