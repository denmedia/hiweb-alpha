<?php
	...
	class phone extends input{
		...
		static function add_repeat_field( Field_Repeat_Options $parent_repeat_field ){
			...
			$parent_repeat_field->add_col_flex_field( self::$input_title, add_field_text( 'mask' )->placeholder( '+9(999)999-99-99' )->default_value( '+9(999)999-99-99' ) )->label('Макска для ввода телефона')->compact(1);
