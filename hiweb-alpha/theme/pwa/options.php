<?php
	...
	add_field_separator( '<i class="fal fa-cog"></i> Основные настройки' )->Location()->Options( 'hiweb-theme-pwa' );
	...
	add_field_text( 'viewport' )->default_value( 'width=device-width, initial-scale=1' )->Location( true );
