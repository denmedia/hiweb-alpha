...
class slide {
    ...
    /**
     * Return slide style classes
     * @return string
     */
    public function get_slide_class_tag() {
        $classes = $this->slide_classes;
    ...
    /**
     * Add / set slide style classes
     * @param array $class
     * @param false $beforeClearClasses
     * @return string[]
     */
    public function add_slide_class($class = [], $beforeClearClasses = false) {
        if ($beforeClearClasses) $this->slide_classes = [];
        if ( !is_array($class)) $class = [ $class ];
        $this->slide_classes = array_merge($this->slide_classes, $class);
        $this->slide_classes = array_unique($this->slide_classes);
        return $this->slide_classes;
    }
