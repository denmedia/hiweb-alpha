<?php
	...
	add_field_text('min-score')->VALUE('0.1')->get_parent_field()->label('Минимальный бал допуска. от 0 до 1.')->description('Данный бал, определяемый сервисом Google reCaptcha v.3, означает вероятность "человечности".<br>Например, <b>0 баллов</b> - означает максимальную вероятность бота, иногда спам может проходить от <b>0.1 балла</b>. Если спам имеет место быть, необходимо поднять бал на 0.1 или выше, чтобы снизить вероятность прохода анти-бот фильтра ботами.')->LOCATION(true);